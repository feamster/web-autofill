...
def site_login(driver):
    ...
    # Symptom Checkbox
    driver.find_element_by_xpath("/html/body/div/div[2]/form/div[2]/div/div[2]/div[6]/div/div/div[2]/div[1]/div[13]/label/div/div[1]/div[2]").click()

    # Select Dropdown
    driver.find_element_by_xpath("/html/body/div/div[2]/form/div[2]/div/div[2]/div[5]/div/div/div[2]/div/div[1]/div[2]").click()

    # Use Down Arrow Keys to Select 7th Option (Teacher)
    time.sleep(0.5)
    for i in range(0,7):
